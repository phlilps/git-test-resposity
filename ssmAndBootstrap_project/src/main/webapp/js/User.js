        ...
        $.ajax({
            ...
            success: function (result) {//成功回调函数
                ...
                for (var i = 0; i < result[0].length; i++) {
                    ...
                    var   roles=ServerObject.roles[0]==undefined?"null":ServerObject.roles[0]
                    html += "<tr>" +
                        '<td><input name="ids" type="checkbox"></td>' +
                        "<td>" +ServerObject.id + "</td>" +
                        "<td>" + ServerObject.username + "</td>" +
                        "<td>" + ServerObject.gender + "</td>" +
                        "<td>" + ServerObject.birthday + "</td>" +
                        "<td>" + ServerObject.phoneNum + "</td>" +
                        "<td>" + ServerObject.site + "</td>" +

            ...
            success: function (result) {//成功回调函数
                ...
                for (var i = 0; i < result[0].length; i++) {
                    ...
                    html += "<tr>" +
                        ...
                        "<td>" + ServerObject.companyCode + "</td>" +
                        "<td>" + ServerObject.companyName + "</td>" +
                        "<td>" + ServerObject.companyDesc + "</td>" +
                        "<td>" + ServerObject.companyUser + "</td>" +
                        "<td>" + ServerObject.comPhoneNum + "</td>" +
                        "<td>" + ServerObject.companySite + "</td>" +
                        '<td class="text-center"> ' +
                        '<a href="javascript:void(0);" onclick="delUser(\'' + ServerObject.id + '\')" class="btn bg-olive btn-xs">删除</a> ' +
                        '<a href="../Providers/return?id=' +ServerObject.id + '"  class="btn bg-olive btn-xs">修改</a> </td>'
                        + "</tr>"
